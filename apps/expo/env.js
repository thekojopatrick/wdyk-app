 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-owner-app-starter.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = "com.kojopatrick_wdyk_app"; // ios bundle id
const PACKAGE = "com.kojopatrick_wdyk_app"; // android package name
...
const SCHEME = "wdyk-app"; // app scheme
